...
import { FaqModelPage } from '../faq-model/faq-model';
...
export class FaqPage {
  lists: Array<{  title: string, Question1: string, Answer1:string,Question2: string, Answer2:string }>;
  constructor(public navCtrl: NavController, public navParams: NavParams,public modalCtrl:ModalController) {
    this.lists=[
      { title:"Busy periods and etiquette", 
      Question1:"Q. Many of those who have recently taken out a membership might find that they can’t get on the machine or bit of equipment they want to use, because it’s January and many gyms are at their busiest.Are there any particular times when they tend to be quieter?",
...
},
{
  ...
  openPage(faq) {
    ...
    let modal = this.modalCtrl.create(FaqModelPage,{title:faq.title,
      Question1:faq.Question1,Answer1:faq.Answer1,
    Question2:faq.Question2,Answer2:faq.Answer2});
    modal.present();
  }
